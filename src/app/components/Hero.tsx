...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      className="pt-28 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-sage-50 to-white"
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-6 sm:gap-8 pt-6 text-sm text-gray-600">
          ...
          {/* Right Image */}
          <div className="relative w-full h-[280px] sm:h-[380px] md:h-[500px] lg:h-[600px]">
